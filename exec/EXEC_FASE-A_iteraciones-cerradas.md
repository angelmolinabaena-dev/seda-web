...
| A1b | H-04 columna ausente | SQL verificado contra BD live, entregado en `EXEC_FASE-A_pasos-manuales-angel.md` §A1 | Post-ejecución: query columna + endpoint sin `PGRST204` | n/a (SQL manual) |
